...
while list_search != []:
    ...
    try:
        ...
        for el in info01:
            ...
            if text != '' and info01 != []:
                with open(tab_lv03_04_years_models, 'a', newline='', encoding="utf-8") as csvfile:
                    writer = csv.writer(csvfile)
                    year = text[0:4]
                    model = text[7:len_text]
                    model_link = f'https://www.fichacompleta.com.br{el.a["href"]}'

                    writer.writerow(
                        [brand, family, year, model, model_link, 'False'])
                    csvfile.close()
